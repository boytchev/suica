...
copy /b bin\suica.js + src\suica-main.js + src\suica-vr.js + src\suica-parser.js + src\suica-drawing.js + src\suica-mesh.js + src\suica-point.js + src\suica-line.js + src\suica-square.js + src\suica-cube.js + src\suica-circle.js + src\suica-sphere.js + src\suica-cylinder.js + src\suica-cone.js + src\suica-group.js + src\suica-tube.js + src\suica-convex.js + src\suica-model.js + src\suica-construct.js + src\suica-scorm.js + src\suica-text3d.js bin\suica.js
