...
//SUICA//			this.colorMatrixLeft = new THREE.Matrix3().fromArray( [ 0.456100, - 0.0400822, - 0.0152161, 0.500484, - 0.0378246, - 0.0205971, 0.176381, - 0.0157589, - 0.00546856 ] );
//SUICA//			this.colorMatrixRight = new THREE.Matrix3().fromArray( [ - 0.0434706, 0.378476, - 0.0721527, - 0.0879388, 0.73364, - 0.112961, - 0.00155529, - 0.0184503, 1.2264 ] );
/*SUICA*/			this.colorMatrixLeft = new THREE.Matrix3().fromArray( [1,0,0,0,0,0,0,0,0] );
/*SUICA*/			this.colorMatrixRight = new THREE.Matrix3().fromArray( [0,0,0,0,1,0,0,0,1] );
