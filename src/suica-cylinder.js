...
class Prism extends Mesh {
	...
	constructor( suica, count, center, size, color, flatShading=true ) {
		...
		count = parseNumber( count, Prism.COUNT );
		...
		this.size = parseSize( size, Prism.SIZE );
		this.color = parseColor( color, Prism.COLOR );
		this.n = count;
